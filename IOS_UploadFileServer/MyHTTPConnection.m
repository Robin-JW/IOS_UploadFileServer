...
- (void) processStartOfPartWithHeader:(MultipartMessageHeader*) header {
	...
	NSString* uploadDirPath = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0] stringByAppendingPathComponent:@"upload"];
